...
function dependencies() {
    ...
    pip3 install git+https://github.com/doomedraven/sflock.git git+https://github.com/doomedraven/socks5man.git pyattck>=2.0.2 distorm3 openpyxl git+https://github.com/volatilityfoundation/volatility3
    #config parsers
